                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="nama_jabatan" class="form-control">
                                                    ...
                                                    <option value="Tidak Punya Jabatan">Tidak Punya Jabatan</option>
                                                    <option value="Staff">Staff</option>
                                                    <option value="Ka.Seksi">Ka.Seksi</option>
                                                    <option value="Ka.Bidang">Ka.Bidang</option>
                                                    <option value="Ka.Subbag">Ka.Subbag</option>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" required name="tanggung_jawab" placeholder="Tanggung Jawab..." class="form-control">
                                            </div>
                                            <div class="form-group">
